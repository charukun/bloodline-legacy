...
const base=process.argv[2]||'be5f92ceb734cee7ed5d9860c2202b974f142f24';
...
const output=template.replace('/*__PAYLOAD__*/',()=>JSON.stringify({code,before,beforeSha,afterSha}).replace(/</g,'\\u003c'));
