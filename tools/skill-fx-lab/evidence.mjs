...
const context=vm.createContext({});for(const f of ['src/render/skill-effects.js','tools/skill-fx-lab/renderer.js'])vm.runInContext(await fs.readFile(path.join(root,f),'utf8'),context);
