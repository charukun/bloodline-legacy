...
const before={};
for(const file of ['legacy/motion.js','legacy/art.js','character/rig.js','character/golden-master.runtime.js','character/traveler-model.js','character/traveler-runtime.js','render/combat-presentation.js'])before[file]=execFileSync('git',['show',beforeSha+':src/'+file],{cwd:root,encoding:'utf8'});
