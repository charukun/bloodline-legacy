...
const before={};
for(const file of ['legacy/motion.js','legacy/art.js','character/rig.js','character/golden-master.runtime.js','character/traveler-model.js','character/traveler-age.js','character/traveler-expression.js','character/traveler-runtime.js','render/combat-presentation.js']){try{before[file]=execFileSync('git',['show',beforeSha+':src/'+file],{cwd:root,encoding:'utf8',stdio:['ignore','pipe','ignore']});}catch(e){if(file.endsWith('traveler-expression.js')||file.endsWith('traveler-age.js'))before[file]='';else throw e;}}
