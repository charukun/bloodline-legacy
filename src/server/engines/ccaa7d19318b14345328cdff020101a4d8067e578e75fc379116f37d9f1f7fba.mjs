...
function facilityStation(s){
 const offsets={sword:[Math.sign(s.x)*1.65,.85,'書見台'],magic:[.8,.9,'読書机'],church:[0,.36,'教会の扉'],armory:[-2.18,1.3,'武具棚'],forge:[-.6,-.58,'金床'],hunter:[0,1.3,'足跡'],dance:[0,2.3,'遊び場']};
...
function nearbyActivity(p,room){return room?.kind==='village'?room.map.schools.find(s=>atFacilityStation(p,s)):null;}
