...
class ArtDirector{
 ...
 doll(p,t,local=false){
  ...
  this.root=rModel(p.x+reaction.x,baseY,p.z+reaction.z,scale*width,scale,scale,facing,pose.roll+reaction.roll+ail.roll,dying*1.48+pose.pitch+reaction.pitch+ail.pitch+(age>65?.055:0));
