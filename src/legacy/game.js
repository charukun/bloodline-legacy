...
class Game{
 ...
 saveWorld(){
  ...
  this.saving=true;try{
   ...
   if(localStorage.getItem(key)!==raw)throw Error('Save verification failed');this.saveBaseRaw=raw;this.saveProfile();this.account?.maybeSave();return true;
