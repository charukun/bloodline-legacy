...
if (manifest.mode === 'game') {
  ...
  assert.deepEqual(Object.keys(assets).sort(), ['village-kit.glb','material-atlas.png',
    'detail-atlas.png','parchment.png','cloth-panel.png','golden-surfaces.png','character/young-human-male-cm01.glb','enemies/sentinel.glb','plaza-craft.glb','plaza-craft-color.png','plaza-craft-detail.png'].sort(),
