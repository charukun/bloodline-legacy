...
const result={pr,sha,environment,urls,verification:'UNVERIFIED'};
...
finally{await fs.writeFile('deploy/evidence/review-published.json',JSON.stringify(result,null,2));}
