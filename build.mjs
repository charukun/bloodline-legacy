...
let style=(await fs.readFile(path.join(root,'src/ui/base.css'),'utf8'))+'\n'+await fs.readFile(path.join(root,'src/ui/world-skin.css'),'utf8');style+='\n'+await fs.readFile(path.join(root,'src/skills/skills.css'),'utf8');style=style.replace(/asset:([a-z-]+\.png)/g,(_,name)=>`data:image/png;base64,${assets[name]}`);
