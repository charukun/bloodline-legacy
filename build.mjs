...
const assets={};for(const name of ['golden-surfaces.png','village-kit.glb','material-atlas.png','detail-atlas.png','parchment.png','cloth-panel.png','character/young-human-male-cm01.glb'])assets[name]=(await fs.readFile(path.join(root,'public/assets',name))).toString('base64');
