...
const assets={};for(const name of ['character/young-human-male-cm01.glb','plaza-craft.glb','plaza-craft-color.png','plaza-craft-detail.png','golden-surfaces.png','village-kit.glb','material-atlas.png','detail-atlas.png','parchment.png','cloth-panel.png'])assets[name]=(await fs.readFile(path.join(root,'public/assets',name))).toString('base64');
