...
const assets={};for(const name of ['village-kit.glb','material-atlas.png','detail-atlas.png','parchment.png','cloth-panel.png'])assets[name]=(await fs.readFile(path.join(root,'public/assets',name))).toString('base64');
const order=['legacy/dialogue.js','legacy/core.js','skills/engine.js','skills/runtime.js','legacy/render_math.js','legacy/motion.js','legacy/art.js','render/tilt-shift.js','render/shaders.js','render/renderer-base.js','legacy/audio.js','legacy/labels.js','legacy/ui.js','legacy/game.js','assets/loader.js','world/environment.js','weather/weather.js','character/rig.js','render/combat-presentation.js','render/adapter.js','audio/ambience.js','skills/presentation.js','bootstrap.js'];
