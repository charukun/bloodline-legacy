...
const assets={};for(const name of ['enemies/sentinel.glb','plaza-craft.glb','plaza-craft-color.png','plaza-craft-detail.png','character/young-human-male-cm01.glb','golden-surfaces.png','village-kit.glb','material-atlas.png','detail-atlas.png','parchment.png','cloth-panel.png'])assets[name]=(await fs.readFile(path.join(root,'public/assets',name))).toString('base64');
