...
const sourceFiles = ['legacy/dialogue.js','legacy/core.js','skills/engine.js','skills/runtime.js','ui/presentation.js','ui/lineage.js','legacy/ui.js','legacy/game.js','skills/presentation.js'];
