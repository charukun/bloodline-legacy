...
function fixture(t, uiSource) {
 ...
 w.eval(code+'\nwindow.testAPI={UI,Game,Simulation,facilityStation,atFacilityStation,uiJourneyHints,MOTHER_LINES,UINoticeQueue,uiCondition,uiPickup,uiActiveStatuses,EQUIP_AGE,MAX_ITEMS};');
