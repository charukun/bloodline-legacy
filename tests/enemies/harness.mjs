...
export function harness(){
 ...
 for(const f of ['enemies/sentinel.js','enemies/equipment.js','enemies/bestiary.js'])vm.runInContext(fs.readFileSync(new URL('../../src/'+f,import.meta.url),'utf8'),ctx,{filename:f});
