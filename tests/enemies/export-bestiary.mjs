...
for(const[fIndex,form]of forms.entries()){
 const p={...scene.sim.actor(form.kind,0,0),id:damage==='stages'?'damage-gallery':'gallery-'+fIndex,enemyForm:form.id,x:(fIndex-(forms.length-1)/2)*4.4,z:-34,dir:damage==='stages'?.85:.10,guard:false,action:'idle',wounds:{},statuses:{}};
 ...
 api.review.damage(p,damage==='stages'?stages[fIndex]:damage,part);
