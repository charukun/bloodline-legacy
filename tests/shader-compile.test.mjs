...
function programs(){
 ...
 for(const file of ['src/render/tilt-shift.js','src/render/shaders.js','src/weather/weather.js','src/character/golden-master.runtime.js','src/character/traveler-age.js','src/character/traveler-runtime.js'])vm.runInContext(read(file),context,{filename:file});
