...
const base=process.argv[2]||'8ade374c84709e9ebcdfc77944b76ead87c0c8ba';
const code=execFileSync('git',['show',base+':src/render/renderer-base.js'],{encoding:'utf8'});
const geometryCache=new Map();
const Before=vm.runInNewContext(code+';Renderer',{Float32Array,Math,RG_CACHE:geometryCache});
const scene=await loadScene(undefined,{characters:false,gameplayCamera:true,width:540,height:960}),r=scene.r;
for(const type of r.static.keys())geometryCache.set(type,r.geometry(type));
