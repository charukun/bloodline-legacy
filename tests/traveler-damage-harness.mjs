...
export function travelerRuntime(revision=null){
 ...
 for(const f of ['legacy/dialogue','legacy/core','skills/engine','skills/runtime','legacy/render_math','legacy/motion','legacy/art','render/tilt-shift','render/shaders','world/environment','character/rig','character/golden-master.runtime','character/traveler-model','character/traveler-expression','character/traveler-runtime']){let source;try{source=read('src/'+f+'.js');}catch(e){if(revision&&f.endsWith('traveler-expression'))continue;throw e;}vm.runInContext(source,context,{filename:f});}
