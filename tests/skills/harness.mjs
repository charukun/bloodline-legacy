...
export function runtime(baseline=false) {
 ...
 source+='\nglobalThis.API={Simulation,skillById,book,makeVillage,staminaMaximum,skillRestriction,actionTiming,effectsOf'+(baseline?'':',BloodlineSkills,BL_SKILL_CATALOG,SkillSystem')+'};';vm.runInContext(source,ctx);return ctx.API;
}
...
export function activity(sim,p,id,seconds) {
 ...
 Object.assign(p,{x:a.x,z:a.z,autoFight:null,input:{x:0,z:0}});
